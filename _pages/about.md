...
My long-term research vision is to solve the "last-centimeter" problem for autonamous intelligent system through an organic intergration between visual perception and control. To this end, we have several recent short-term focuses: 1. simultaneous localization and mapping (SLAM) for dynamic scenes and systems; 2.learning efficient visual perception model with uncertainty 3.learning visual representation of environment to form constraints and objectives in model predictive control. 

Prospective students: I am looking for fully funded Ph.D. students who are self-motivated. If you are interested in working with me, please sign up [this google form](https://docs.google.com/forms/d/e/1FAIpQLSdaWiIy3ukuPdtrmkGm5Th9jo082tSA3MfOlKx0q-CuHu4g4w/viewform). Students from majors other than computer science are also encourgeted to apply.
